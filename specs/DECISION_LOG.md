...
2026-04-10 00:02 | SPECIFICATION.md, IMPLEMENTATION_PLAN.md, TEST_PLAN.md, README.md, CLAUDE.md | Rename the "Uniform" practice mode label to "Random" for clarity; underlying behavior unchanged (still uniform distribution). `PracticeMode.uniform` case renamed to `.random`.
<!-- LOG_END -->
